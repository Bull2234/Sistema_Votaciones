...
include("C:/xampp/htdocs/xampp/eDemocracia_src/php/conexion_be.php");
                            ...
                            $sql = "SELECT c.nombres, c.apellidos
                                    FROM ciudadanos c
                                    INNER JOIN candidatos ca ON c.identificacion = ca.identificacion where tipovotacion=101";
          ...
          <div class="col-md-2">
          <button type="submit" class="btn btn-info" name="enviar" btn btn-primary btn-block" onclick="return verificarCheckbox();">Votar</button>          
        </div>
        </form>
      </div>
    </div>
